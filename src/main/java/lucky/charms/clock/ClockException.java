...
public class ClockException extends Exception {
   private static final long serialVersionUID = 6217528706760068956L;
    ...
    * @since 1.7
    */
   protected ClockException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
