 ...
 */
package luckycharms.logging.plugins;
 ...
 * </p>
 */
@Plugin(name = "BasicHtmlLayout", category = Node.CATEGORY, elementType = Layout.ELEMENT_TYPE, printObject = true)
public final class BasicHtmlLogLayout extends AbstractStringLayout {
   ...
   public static enum FontSize {
      ...
      LARGE("large"), XLARGE("x-large"), XXLARGE("xx-large"), LARGER("larger");
      ...
      public String getFontSize() { return size; }
   ...
   private BasicHtmlLogLayout(final boolean locationInfo, final String title,
         final String contentType, final Charset charset, final String font, final String fontSize,
    ...
    * For testing purposes.
    */
   public boolean isLocationInfo() { return locationInfo; }
   ...
   private String addCharsetToContentType(final String contentType) {
      ...
      return contentType.contains("charset") ? contentType
   ...
   public String toSerializable(final LogEvent event) {
      ...
      sbuf.append(MarketTimeUtils.format(event.getTimeMillis()));
      sbuf.append("</td>").append(Strings.LINE_SEPARATOR);

      final String escapedThread = Transform.escapeHtmlTags(event.getMarker().toString());
      sbuf.append("<td title=\"").append(escapedThread).append(" marker\">");
...
//      }
      ...
      if (event.getContextData() != null && !event.getContextData().isEmpty()) {
         ...
         sbuf.append("MDC: ")
               .append(Transform.escapeHtmlTags(event.getContextData().toMap().toString()));
         sbuf.append("</td></tr>").append(Strings.LINE_SEPARATOR);
      }
    ...
    * 
    * @param locationInfo If "true", location information will be included. The
    *                     default is false.
    ...
    * @param charset      The character set to use. If not specified, the default
    *                     will be used.
    ...
    */
   @PluginFactory
   public static BasicHtmlLogLayout createLayout(
      ...
      return new BasicHtmlLogLayout(locationInfo, title, contentType, charset, font, fontSize,
            headerSize);
   }
    ...
    * @return an HTML Layout.
    */
   public static BasicHtmlLogLayout createDefaultLayout() {
   ...
   public static class Builder
         implements org.apache.logging.log4j.core.util.Builder<BasicHtmlLogLayout> {
      ...
      @Override
      public BasicHtmlLogLayout build() {
         // TODO: extract charset from content-type
         if (contentType == null) {
            contentType = DEFAULT_CONTENT_TYPE + "; charset=" + charset;
         }
         return new BasicHtmlLogLayout(locationInfo, title, contentType, charset, fontName,
               fontSize.getFontSize(), fontSize.larger().getFontSize());
      }
   }
}
